...
if ((isGuest.indexOf('Sign in') > -1)||(isGuest.indexOf('Guest') > -1)){
			...
			a.href = 'https://sal-shib.hosted.exlibrisgroup.com/pds?func=load-login&calling_system=primo&institute=44SAL&lang=eng&url=http://sal-primo-production.hosted.exlibrisgroup.com/primo_library/libweb/pdsLogin?targetURL='+currentUrl+'&from-new-ui=1&authenticationProfile=Profile+1';
...
/*START GOOGLE ANALYTICS 
	/* THIS IS SPECIFIC TO PRODUCTION */
